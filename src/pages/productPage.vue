          ...
          <form class="form" action="#" method="POST">
            ...
            <fieldset class="form__block">
              ...
              <ul class="colors">
                <li class="colors__item">
                  <label for="input_1" class="colors__label">
                    <input id="input_1" class="colors__radio sr-only" type="radio" name="color-item"
                           value="blue"
                           checked="">
                ...
                <li class="colors__item">
                  <label for="input_2" class="colors__label">
                    <input id="input_2" class="colors__radio sr-only" type="radio" name="color-item"
                           value="yellow">
                ...
                <li class="colors__item">
                  <label for="input_3" class="colors__label">
                    <input id="input_3" class="colors__radio sr-only" type="radio" name="color-item"
                           value="gray">
            ...
            <fieldset class="form__block">
              ...
              <ul class="sizes sizes--primery">
                <li class="sizes__item">
                  <label for="input_4" class="sizes__label">
                    <input id="input_4" class="sizes__radio sr-only" type="radio" name="sizes-item"
                           value="32">
                ...
                <li class="sizes__item">
                  <label for="input_5" class="sizes__label">
                    <input id="input_5" class="sizes__radio sr-only" type="radio" name="sizes-item"
                           value="64">
                    <span class="sizes__value">
                      64gb
                    </span>
                ...
                <li class="sizes__item">
                  <label for="input_6" class="sizes__label">
                    <input id="input_6" class="sizes__radio sr-only" type="radio" name="sizes-item"
                           value="128"
                           checked="">
                    <span class="sizes__value">
                      128gb
            ...
            <div class="item__row">
              <div class="form__counter">
                ...
                <label for="input_1">
                  <input id="input_1" type="text" value="1" name="count">
                </label>
